...
/**
 * Created by JGriffin on 01/09/2014.
 */

/**
 * Allows easy access to the private mCurrentPrimaryItem field in FragmentStatePagerAdapter.
 ...
 */
public abstract class PublicisedFragmentStatePagerAdapter extends PagerAdapter {
    ...
    public PublicisedFragmentStatePagerAdapter(FragmentManager fm) {
        mFragmentManager = fm;
    }
